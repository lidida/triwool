			...
			<div class="row">
				<div class="col-lg-9">
					<div class="m-b-md order-title">
						<h2>
							<small><a @click="$router.push('/suppliers')">Suppliers</a></small> / 
									...
									<a class="row">
										<div class="col-4">
											<div class="text-center">
												<h3>Orders</h3>
												<br>
												<span @click="goToOrder(1000045)">1000045</span><br>
												<span @click="goToOrder(1000020)">1000020</span><br>
												<span @click="goToOrder(1000018)">1000018</span><br>
												<span @click="goToOrder(1000017)">1000017</span><br>
