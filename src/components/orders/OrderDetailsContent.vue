	...
	<div>
				...
				<div class="contact-box">
					<a class="row">
						<div class="col-4">
							<div class="text-center">
								...
								<div class="m-t-xs font-bold">Watter</div>
							</div>
						</div>
						<div class="col-8" style="text-align: center;">
							<span
								class="badge badge-default m-t-sm m-b-sm">
								<strong><a>Know more</a></strong>
							</span>
						</div>
					</a>
					<div class="contact-box-footer">
						<div class="m-t-xs btn-group">
							<span
								class="badge badge-primary m-t-sm m-b-sm">
		...
		<div class="row m-t-lg">
			<div
				...
				<div class="col-lg-3">
					<button class="btn btn-block m-b-lg"
						@click="selectedChart = 1; $emit('pick', 1)"
						:class="{'btn-primary': selectedChart == 1, 'btn-default': selectedChart == 2}">This order</button>
				</div>
				<div class="col-lg-3">
					<button class="btn btn-block m-b-lg"
						@click="selectedChart = 2; $emit('pick', 2)"
						:class="{'btn-primary': selectedChart == 2, 'btn-default': selectedChart == 1}">Improved</button>
				</div>
			</div>
			...
			<div
				...
				<div class="col-lg-3">
					<button class="btn btn-block m-b-lg"
						...
						:class="{'btn-primary': selectedChart == 3, 'btn-default': selectedChart == 4}">This year</button>
				</div>
				<div class="col-lg-3">
					<button class="btn btn-block m-b-lg"
						@click="selectedChart = 4; $emit('pick-year', 4)"
						:class="{'btn-primary': selectedChart == 4, 'btn-default': selectedChart == 3}">Last year</button>
				</div>
			</div>
				...
				scales: {
					yAxes: [
						...
						},
						{
							...
							ticks: (this.selectedChart == 1 || this.selectedChart == 2) ? {max: 4000,min: 0} : {max: 15, min: 0} 
						}
					],
					xAxes: [
						{
