<template>
  <page class="orders" :mode="'orders'" @add-order="addOrder()">
    <div class="row">
      <div class="col-lg-2 m-t-lg">
        <span v-for="filter in filters" :key="filter.id">
          ...
          ></i>
          {{ filter.description }}
          <template v-if="filter.visible">
            <br>
            <br>
            <span v-for="subFilter in filter.subFilters" class="sub-filter" :key="subFilter.id">
              <i
                v-if="subFilter.active"
                class="check-icon-lg fa fa-square colored-icon"
                @click="toggleSubFilter(subFilter)"
              ></i>
              <i
                v-else
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a @click="goToOrder(10000044)">10000044</a>
                    </td>
                    <td>Skirts</td>
                    <td>Benetton</td>
                    <td>3,000</td>
                  ...
                  <tr>
                    <td>
                      <a @click="goToOrder(10000043)">10000043</a>
                    </td>
                    <td>Dresses</td>
                    <td>Bershka</td>
                    <td>5'000</td>
                  ...
                  <tr>
                    <td>
                      <a @click="goToOrder(10000042)">10000042</a>
                    </td>
                    <td>Dresses</td>
                    <td>Benetton</td>
                    <td>17'000</td>
                  ...
                  <tr>
                    <td>
                      <a @click="goToOrder(10000041)">10000041</a>
                    </td>
                    <td>T-shirts</td>
                    <td>Zara</td>
                    <td>25'000</td>
